...
import com.example.taller.service.BaseService;
...
public abstract class BaseController<T extends BaseEntity<ID>, ID> {
    ...
    protected void preBaja()throws ErrorServicio {}
    protected void postBaja()throws ErrorServicio {}
    protected void preActualizacion()throws ErrorServicio {}
    protected void postActualizacion()throws ErrorServicio {}
