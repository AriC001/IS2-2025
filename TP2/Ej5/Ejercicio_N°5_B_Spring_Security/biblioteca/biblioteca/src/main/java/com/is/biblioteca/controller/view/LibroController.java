...
public class LibroController {
    ...
    public String aceptarEditModificar(@PathVariable Long isbn, String idLibro, String titulo, Integer ejemplares, String idAutor, String idEditorial, ModelMap modelo, @RequestParam(required = false) MultipartFile archivo) {
        try {
            ...
            libroService.modificarLibro(archivo, idLibro, isbn, titulo, ejemplares, idAutor, idEditorial);
