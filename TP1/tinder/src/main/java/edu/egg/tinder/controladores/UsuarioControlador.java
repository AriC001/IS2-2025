...
public class UsuarioControlador {
    ...
    public String registroUsuario(ModelMap modelo, @RequestParam("archivo") MultipartFile archivo, @RequestParam String nombre, @RequestParam String apellido, @RequestParam String mail, @RequestParam String clave1, @RequestParam String clave2, @RequestParam String idZona){
        try{
